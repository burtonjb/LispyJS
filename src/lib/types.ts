...
export type atom = string | number; //An atom is either a number of a string. Its a singular value
...
export type env = {}; // the env is a mapping of var->val. Represented as an object
